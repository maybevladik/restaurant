    ...
    return (
            <Container className="container-fluid" style ={{marginTop: -20}} >
                ...
                <h5 style={{color: "green", lineHeight: 2 }} >Ласкаво просимо до нашого ресторану, де ваші смакові рецептори зануряться у світ смаків,
                    а ваші втому та суєта знайдуть пристань у спокійній та затишній атмосфері.
                    </h5>
                <h5 style={{color: "green", lineHeight: 2 }} >Наш ресторан - це справжнє гастрономічне пригода, яка запрошує вас на чарівну подорож у світ
