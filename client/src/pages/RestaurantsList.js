...
const Block = ({ image, text, url, addres }) => (
    <div className="block">
    ...
    return (
        ...
        <div className="container">
            {blocksData.map((block, index) => (
                <Block key={index} image={block.image} text={block.text} url={block.url} addres = {block.addres} />
            ))}
        </div>
        </Container>
    );
